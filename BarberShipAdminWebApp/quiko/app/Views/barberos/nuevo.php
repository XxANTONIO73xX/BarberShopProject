<div id="layoutSidenav_content">
    <main>
         <div class="container-fluid px-4">
            ...
            <form method ="POST" action="<?php echo base_url(); ?>/barbero/insertar" autocomplete = "off">
            <?php csrf_field(); ?>    
            <div class="form-group">
                    <div class ="row">
                        <div class="col-12 col-sm-6">
                         ...
                         <div class="col-12 col-sm-6">
                            <label>Apodo</label>
                             <input class="form-control" id="apodo" name="apodo" type="text" required />
                         </div>
                ...
                <div>
                    ...
                    <a href="<?php echo base_url(); ?>/barbero" class="btn btn-primary">Regresar</a>
